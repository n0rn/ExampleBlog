...
<header class="main-header">
    <div class="container">
        <div id="header">
            ...
            <div class="widget-area widget-header">	<ul><div class="textwidget"><img src="/web/images/103642-1335226181.png"></div></ul></div>
        </div><!--#header-->
    </div><!--.container-->
</header>
...
<div class="container">
    <div class="secondary-navigation">
        <nav id="navigation">
            <ul class="menu"><li class="menu-item"><a href="<?=Yii::$app->urlManager->createUrl(["site/index"])?>">Home</a></li>
                <li class="menu-item"><a href="<?=Yii::$app->urlManager->createUrl(["site/about"])?>">About</a></li>
                <li class="menu-item"><a href="<?=Yii::$app->urlManager->createUrl(["site/contact"])?>">Contact Us</a></li>
                <li class="menu-item"><a href="<?=Yii::$app->urlManager->createUrl(["site/video"])?>">Video</a></li>
                <li class="menu-item"><a href="<?=Yii::$app->urlManager->createUrl(["site/rev"])?>">Reviews</a></li>
            </ul>
                ...
                <div class="post excerpt ">
                    ...
                    <div class="post-content image-caption-format-1">
                        <a href="#" rel="nofollow" id="featured-thumbnail">
                            ...
                            <div class="featured-thumbnail"><img src="/web/images/2457315858_32ffd98aec_n-150x150.jpg" class="attachment-featured wp-post-image" height="150" width="150"></div>															</a>
                ...
                <div class="post excerpt ">
                    ...
                    <div class="post-content image-caption-format-1">
                        <a href="#" rel="nofollow" id="featured-thumbnail">
                            ...
                            <div class="featured-thumbnail"><img src="/web/images/6585158069_29788f608e_n-150x150.jpg" class="attachment-featured wp-post-image" height="150" width="150"></div>															</a>
                ...
                <div class="post excerpt last">
                    ...
                    <div class="post-content image-caption-format-1">
                        <a href="#" rel="nofollow" id="featured-thumbnail">
                            ...
                            <div class="featured-thumbnail"><img src="/web/images/44066633_e0ab44de09_n-150x150.jpg" class="attachment-featured wp-post-image" height="150" width="150"></div>															</a>
                ...
                <div class="post excerpt ">
                    ...
                    <div class="post-content image-caption-format-1">
                        <a href="#" rel="nofollow" id="featured-thumbnail">
                            ...
                            <div class="featured-thumbnail"><img src="/web/images/2470289415_b98e0e1dae_n-150x150.jpg" class="attachment-featured wp-post-image" height="150" width="150"></div>															</a>
                ...
                <div class="post excerpt last">
                    ...
                    <div class="post-content image-caption-format-1">
                        <a href="#" rel="nofollow" id="featured-thumbnail">
                            ...
                            <div class="featured-thumbnail"><img src="/web/images/3478158612_4a09ab2d3c-150x150.jpg" class="attachment-featured wp-post-image" height="150" width="150"></div>															</a>
                        <p>Nulla sagittis convallis arcu. Sed sed nunc. Curabitur
                            consequat. Quisque metus enim, venenatis fermentum, mollis in, porta et,
                            nibh. Duis vulputate elit in elit. Mauris dictum libero id justo. Fusce
                            in est. Sed nec diam. Pellentesque habitant morbi tristique senectus et
